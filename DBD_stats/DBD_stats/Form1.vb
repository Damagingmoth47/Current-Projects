Public Class dbdStatsFRM
    ...
    Private Sub GenPopped()
        Dim popTime As TimeSpan = Date.Now - gameStartTime
        Dim mins, seconds As Integer
        mins = popTime.Minutes
        seconds = popTime.Seconds
        gensComplete += 1
    ...
    Private Sub printBTN_Click(sender As Object, e As EventArgs) Handles printBTN.Click
        ...
        My.Computer.FileSystem.WriteAllText("C:\DBDstats\DBDstats.txt", output, True)
        ClearVals()
